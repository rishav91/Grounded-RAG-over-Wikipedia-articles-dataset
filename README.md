...
| Implementation | M0 (ingestion/indexing), M1 (hybrid retrieval + ACL filter), M2 (reranking), M3 (grounded generation, citations, faithfulness, abstain, tool use) done — see [ROADMAP.md](docs/ROADMAP.md); M4 onward not started |
